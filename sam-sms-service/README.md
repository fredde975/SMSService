...
This is a sample template for sam-sms-service - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name sam-sms-service --query 'Stacks[].Outputs'
```
